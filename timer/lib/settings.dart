        ...
        body: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
            InkWell(
                ...
                highlightColor: const Color.fromARGB(6, 150, 150, 150),
                splashColor: const Color.fromARGB(15, 150, 150, 150),
                child: Container(
                  width: 180,
                  height: 200,
            ...
            InkWell(
                ...
                child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            color: MyApp.thememe[MyApp.currentTheme]
                                [MyApp.format == 1 ? 'primary' : 'secondary']!,
                            width: 3)),
                    padding: const EdgeInsets.all(20),
                    child: Row(children: [
                      NumberPicker(
                        ...
                        Text('  Dark mode',
                            style: TextStyle(
                                ...
                                color: MyApp.thememe[MyApp.currentTheme]
                                    ['text'])),
                        Switch(
                            activeColor: MyApp.thememe[MyApp.currentTheme]
                                ['primary'],
                            activeTrackColor: MyApp.thememe[MyApp.currentTheme]
                                ['primary'],
                            inactiveThumbColor:
                                MyApp.thememe[MyApp.currentTheme]['disabled'],
                            inactiveTrackColor:
                                MyApp.thememe[MyApp.currentTheme]['disabled'],
                            splashRadius: 17,
